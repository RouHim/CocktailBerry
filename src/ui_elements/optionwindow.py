...
# Form implementation generated from reading ui file 'src/ui_elements/optionwindow.ui'
#
...
class Ui_Optionwindow(object):
    def setupUi(self, Optionwindow):
        ...
        self.button_about = QtWidgets.QPushButton(self.scrollAreaWidgetContents)
        self.button_about.setMinimumSize(QtCore.QSize(0, 80))
        self.button_about.setMaximumSize(QtCore.QSize(5000, 300))
        font = QtGui.QFont()
        font.setPointSize(28)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.gridLayout_2.addWidget(self.button_about, 9, 0, 1, 2)
