...
allowed_keys = Literal[
    ...
    "calibration_accept_pump_mode_only",
    "calibration_amount_label",
    "calibration_channel_label",
    "calibration_exit_button",
    "calibration_header",
    "calibration_success",
    "calibration_update_failed_format",
    ...
    "element_not_found",
    "enter_cocktail_name",
    "flow_rate_out_of_bounds",
    "flow_rate_unrealistic_warning",
